...
class PlotGyro(pg.GraphicsWindow):
    ...
    def __init__(self, serial, *args):
        ...
        self.xyz_graph = self.addPlot(title='Gyro XYZ')
        ...
        _current_size = len(UwbNetwork.nodes[self.serial].cdp_pkts[MPUGyroscopeV2.type])
    ...
    def timerEvent(self, e):
        ...
        _current_size = UwbNetwork.nodes[self.serial].cdp_pkts_count[MPUGyroscopeV2.type] - self.last_count
        self.last_count = UwbNetwork.nodes[self.serial].cdp_pkts_count[MPUGyroscopeV2.type]
