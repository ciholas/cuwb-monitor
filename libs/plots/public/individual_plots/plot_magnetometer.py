...
class PlotMagnetometer(pg.GraphicsWindow):
    ...
    def __init__(self, serial):
        ...
        self.xyz_graph = self.addPlot(title='Magnetometer XYZ')
        ...
        _current_size = len(UwbNetwork.nodes[self.serial].cdp_pkts[MPUMagnetometerV1.type])
    ...
    def timerEvent(self, e):
        ...
        _current_size = UwbNetwork.nodes[self.serial].cdp_pkts_count[MPUMagnetometerV1.type] - self.last_count
        self.last_count = UwbNetwork.nodes[self.serial].cdp_pkts_count[MPUMagnetometerV1.type]
