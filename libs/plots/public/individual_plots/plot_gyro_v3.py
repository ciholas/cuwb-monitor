...
# Local libraries
from cdp import GyroscopeV3
from network_objects import *
from settings import *


class PlotGyroV3(QtWidgets.QMainWindow):
    type = GyroscopeV3.type
    ...
    def __init__(self, serial):
        ...
        self.serial = serial
        self.setWindowTitle('CUWB Monitor - Gyroscope V3 Devices ID: 0x{:08X}'.format(serial))
    ...
    def labelClickEvent(self, serial, e):
        self.sub_windows.update([(serial, PlotGyroV3SubWindow(serial, self))])
...
class PlotGyroV3SubWindow(pg.GraphicsLayoutWidget):
    def __init__(self, serial, parent):

        pg.GraphicsLayoutWidget.__init__(self)
        self.setWindowTitle('CUWB Monitor - Gyro V3 Plot ID: 0x{:08X}'.format(serial))
        self.serial = serial
