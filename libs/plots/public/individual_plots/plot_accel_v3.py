...
# Local libraries
from cdp import AccelerometerV3
from network_objects import *
from settings import *


class PlotAccelV3(QtWidgets.QMainWindow):
    type = AccelerometerV3.type
    ...
    def __init__(self, serial):
        ...
        self.serial = serial
        self.setWindowTitle('CUWB Monitor - Accelerometer V3 Devices ID: 0x{:08X}'.format(serial))
    ...
    def labelClickEvent(self, serial, e):
        self.sub_windows.update([(serial, PlotAccelV3SubWindow(serial, self))])
...
class PlotAccelV3SubWindow(pg.GraphicsLayoutWidget):
    def __init__(self, serial, parent):

        pg.GraphicsLayoutWidget.__init__(self)
        self.setWindowTitle('CUWB Monitor - Accel V3 Plot ID: 0x{:08X}'.format(serial))
        self.serial = serial
